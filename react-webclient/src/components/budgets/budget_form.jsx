        ...
        <div className="row">
          <div className="large-5 medium-5 columns">
            <div>
              ...
              <InputField id='monthly_income' required onChange={this.updateBudget} type='number' name='monthly_income' step='any' min='0.00' placeholder='0.00' value={this.state.monthly_income} errors={budget.errors} />
            </div>
            <div>
