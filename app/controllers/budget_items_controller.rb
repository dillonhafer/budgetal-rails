class BudgetItemsController < ApplicationController
  ...
  def create
    ...
    budget = bi.budget_category.budget
    if bi.save
      respond_to do |format|
        format.html { redirect_to my_budgets_path(month: budget.month, year: budget.year), notice: 'Created Budget Item' }
  ...
  def update
    ...
    if bi.update_attributes params[:budget_item]
      respond_to do |format|
        format.html { redirect_to my_budgets_path(month: budget.month, year: budget.year), notice: 'Updated Budget Item' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { flash[:notice] = "Deleted Budget Item"; redirect_to my_budgets_path(month: budget.month, year: budget.year) }
